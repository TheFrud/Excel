...
public class EniroAPIExample { 
	...
	public void makeQuery(String string1, String string2) throws IOException {
		URL eniroApiUrl = new URL("http://api.eniro.com/cs/search/basic?profile=main90&key=8901680732498287504&country=se&version=1.1.3&search_word=" +  string1); 
